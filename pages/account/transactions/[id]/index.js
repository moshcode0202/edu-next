    ...
    return (
        <>
                ...
                title={
                    <>
                        <li className="font-semibold text-primary">
                            <Link href="/account/transactions" className="hover:text-primary/80">
                                Transactions
                            </Link>
                        </li>
                        <li>/ #eRO-100</li>
            ...
            <div className="p-4 lg:p-10 lg:pt-[45px]">
                <div className="mb-5">
                    <p className="mb-5 inline-flex flex-1 items-center">
                        <strong className="mr-2">Thanks for your order!</strong> 07 June 2023 at 10:15 am
                        <span className="status ml-5">Processing</span>
                    </p>
                ...
                <div className="flex flex-col gap-4 xl:flex-row xl:gap-[30px]">
                    <div className="mb-5 flex-1 lg:mb-0">
                                    ...
                                    <tr>
                                        <td>
                                            <span className="inline-flex items-center gap-1 pl-5">
                                                Donation Disbursed <IconQuestion />
                                            </span>
                                        </td>
                        ...
                        <h2 className="mb-2.5 text-xl font-semibold">Order Notes</h2>
                        ...
                        <ul className="relative space-y-5 before:absolute before:inset-y-4 before:left-[5px] before:border-l before:border-primary/10">
                            <li className="flex items-center gap-4">
                                ...
                                <div className="flex-1 justify-between gap-4 sm:flex">
                                    <div>
                                        A tracking number <strong className="text-primary">#123456</strong> was assigned
                                        to your order.
                                    </div>
